...
## Team 1
-
    - Christopher - UI/UX/Lead
    - Hayley - Programming
    - Aidan - Environment
    - Miranda - Modeling/Animation
    - Cleve - Environment
...
-
    - Programming
        ...
        - Pickup spawner spawning pickups as intended without much effort
        - Switching pickups to touch instead of interact was a better choice
        - Enemy spawners functioning as intended
        - Enemy hit reaction implemented

    - Environment

        - Environmental "Clutter" added to improve feel of environment
        - Adjusted level lighting to be more consistent

    - Modeling/Animation

        - Animations function as intended

    - UI/UX

        - Creating main menu
        - Utilizing the scene instead of a flat menu
        - Utilizing additional fonts

### What Went Wrong
-
    - Programming

        - Could not get damage increase and x-ray pickups to function

    - Environment

        - Nothing of note (aside from some few issues with power outages)

    - Modeling/Animation

        - Rigging was complicated
...
### Integration of Previous Evaluations
-
    - Utilizing asset spread sheet has enabled us to better track what we needed to complete
    - Setting better deadlines to facilitate finding bugs
    - Weekly outline covering each departments "need to do's"

### Do Differently
-
    - This week we felt happy about our collaboration

### Tools & techniques That Were Not Helpful
-
    - Need a better understanding of how certain blueprint nodes work, faced issues of "accessed 'NONE'" bugs, and did not know how to work around it
    - Utilizing YouTube has lead to mixed results for programming
